import { Serializer, JsonObject, JsonIgnore, Enumerable } from '@ca-webstack/reflection';
...
export abstract class TrackableEntity<TIdentifier = string>
  ...
  public constructor() {
    super();
    setTimeout(() => this.changeTracker.changeTrackingEnabled = true);
  }
  ...
  public acceptChanges() {
    this.changeTracker.acceptChanges(this);
  }
