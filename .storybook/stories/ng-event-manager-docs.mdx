...
<Meta title="ng-event-manager/Docs" />
...
[Full API documentation](https://github.com/codearchitects/CodeArchitects.EnterprisePlatform.WebStack/blob/master/ca-ng-event-manager/docs/index.md)
