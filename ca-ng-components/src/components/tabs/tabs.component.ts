...
export class ShTabsComponent extends ShBaseAuthComponent<IShBaseOptions> implements OnInit {
   ...
   */
  @ContentChild('content', { static: false }) public template: TemplateRef<HTMLElement>;
  /**
   * Current tab
   */
  public current: IShTab;
  /**
   * Tab content template context
   */
  protected templateContext: { $implicit: IShTab } = { $implicit: undefined };
  /**
   * Tabs component
   */
