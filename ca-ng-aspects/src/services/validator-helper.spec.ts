  ...
  describe('Validator helper', () => {
    ...
    describe('Base class', () => {
      ...
      it('should return undefined control from undefined', () => {
        // Act
        let control = validatorHelper.getControl(undefined, 'firstName');
      ...
      it('should return empty form control if target as no descriptors', () => {
        // Act
        let control = validatorHelper.getControl(person, 'lastName');
      ...
      it('should return different control', () => {
        // Act
        let control1 = validatorHelper.getControl(person, 'lastName');
        let control2 = validatorHelper.getControl(person, 'lastName');
      ...
      it('should return group validation message', () => {
        // Act
        let group = validatorHelper.getGroup(person);
        group.addControl('firstName', validatorHelper.getControl(person, 'firstName'));
        group.addControl('lastName', validatorHelper.getControl(person, 'lastName'));
    ...
    describe('Derived class', () => {
      ...
      it('should return form control from derived class', () => {
        // Act
        let control = validatorHelper.getControl(ChildPerson, 'firstName');
      ...
      it('should return empty form control if target as no descriptors', () => {
        // Act
        let control = validatorHelper.getControl(childPerson, 'lastName');
      ...
      it('should return different control', () => {
        // Act
        let control1 = validatorHelper.getControl(childPerson, 'lastName');
        let control2 = validatorHelper.getControl(childPerson, 'lastName');
