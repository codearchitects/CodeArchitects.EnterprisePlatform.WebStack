...
export function setChangeDetectionStrategy(strategy: ChangeDetectionStrategy) {
  ...
  console.log(
    `%c CHANGE DETECTION STRATEGY CHANGED TO ${ChangeDetectionStrategy[strategy]}`,
    'background:#129bdb;color:white'
  );
}

export function caepChangeDetectorStrategy(): ChangeDetectionStrategy.OnPush | ChangeDetectionStrategy.Default {
